...
set rc [catch {
  ...
  set_property webtalk.parent_dir C:/Users/raffy/Documents/Vivado_projects/Varie/Raff_multiplier/Raff_multiplier.cache/wt [current_project]
  set_property parent.project_path C:/Users/raffy/Documents/Vivado_projects/Varie/Raff_multiplier/Raff_multiplier.xpr [current_project]
  set_property ip_output_repo C:/Users/raffy/Documents/Vivado_projects/Varie/Raff_multiplier/Raff_multiplier.cache/ip [current_project]
  set_property ip_cache_permissions {read write} [current_project]
  add_files -quiet C:/Users/raffy/Documents/Vivado_projects/Varie/Raff_multiplier/Raff_multiplier.runs/synth_1/Pipeline.dcp
  read_xdc C:/Users/raffy/Documents/Vivado_projects/Varie/Raff_multiplier/Raff_multiplier.srcs/constrs_1/new/clk.xdc
  link_design -top Pipeline -part xc7z020clg400-1
...
set rc [catch {
  ...
  create_report "impl_1_route_report_timing_summary_0" "report_timing_summary -max_paths 10 -file Pipeline_timing_summary_routed.rpt -pb Pipeline_timing_summary_routed.pb -rpx Pipeline_timing_summary_routed.rpx"
...
set rc [catch {
  ...
  phys_opt_design -directive AggressiveExplore
  write_checkpoint -force Pipeline_postroute_physopt.dcp
  create_report "impl_1_post_route_phys_opt_report_timing_summary_0" "report_timing_summary -max_paths 10 -warn_on_violation -file Pipeline_timing_summary_postroute_physopted.rpt -pb Pipeline_timing_summary_postroute_physopted.pb -rpx Pipeline_timing_summary_postroute_physopted.rpx"
  create_report "impl_1_post_route_phys_opt_report_bus_skew_0" "report_bus_skew -warn_on_violation -file Pipeline_bus_skew_postroute_physopted.rpt -pb Pipeline_bus_skew_postroute_physopted.pb -rpx Pipeline_bus_skew_postroute_physopted.rpx"
